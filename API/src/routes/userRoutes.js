const { getAllUsersCtrl, getOneUserCtrl, updateByAdminCtrl, updateUserProfileCtrl, deleteUserCtrl, getCurrentUserCtrl } = require("../controllers/userController")
...
const { updateUserProfileSchema,updateByAdminSchema } = require("../validation/userValidation")
